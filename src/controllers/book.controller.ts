...
import { findEntry, createEntry, findAndDelete, findAndUpdate } from "@src/adapters";
...
export const addBook = async (req: Request, res: Response) => {
    try {
        ...
        if (existanceCheckResult)
            return res.status(HTTP_STATUS.OK).send({ successful: false, message: message.Book_Already_Exists, existanceCheckResult });
